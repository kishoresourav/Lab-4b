...
int main () {
      ...
      cin >> upperLimit;
      cout << "Sum of even natural numbers between " << lowerLimit << " and " << upperLimit << " = " <<  sum_even(lowerLimit ,upperLimit) << endl;
      cout << "Sum of odd natural numbers between " << lowerLimit << " and " << upperLimit << " is " <<  sum_odd(lowerLimit ,upperLimit) << endl ;
